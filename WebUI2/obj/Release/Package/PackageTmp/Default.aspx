                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <h1 class="brand-heading">
                                <asp:Label ID="lblCap" runat="server" Text="Label">Catch Me!</asp:Label></h1>
                            <p class="intro-text">
                        ...
                        <div class="row-fluid">
                            <asp:Label ID="lblMessage" runat="server" class="span6 intro-text">Pic1</asp:Label>
                            <br />
                            <asp:FileUpload ID="FileUpload1" runat="server" BorderStyle="None" class="span6 intro-text"/>
                            <br />
                            <asp:Image ID="Image1" runat="server" class="span6"  style="max-width:50%"/>
                        </div>

                        <div class="row-fluid">
                            <asp:Label ID="lblMessage2" runat="server" class="span6 intro-text">Pic2</asp:Label>
                            <br />
                            <asp:FileUpload ID="FileUpload2" runat="server" BorderStyle="None" class="span6 intro-text"/>
                            <br />
                            <asp:Image ID="Image2" runat="server" class="span6" style="max-width:50%"/>
                        </div>
  </div>
